# see the package.json as well:
  react react-redux reux-thunk(middleware for redux) installed
  {Provider} was used on App.js instead index.js to glue everything together
